...
class AccountRemoteDataSource implements AccountDataSource{
  ...
  @override
  Future<ChiscoResponse> editUserInformation(String? location,String? birthday,String? fullName) async {
    ChiscoResponse chiscoResponse = await _httpClient.put(url: 'user/edit', data: {'birthday':birthday,'location':location,'fullName':fullName});
